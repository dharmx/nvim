...
M.mappings = {
  ...
  ["<leader>b"] = {
    ...
    ["="] = {
      ["name"] = "ﮄ Goto Buffer",
      ["1"] = { "<CMD>BufferLineGoToBuffer 1<CR>", " 0" },
      ["2"] = { "<CMD>BufferLineGoToBuffer 2<CR>", " 1" },
      ["3"] = { "<CMD>BufferLineGoToBuffer 3<CR>", " 2" },
      ["4"] = { "<CMD>BufferLineGoToBuffer 4<CR>", " 3" },
      ["5"] = { "<CMD>BufferLineGoToBuffer 5<CR>", " 4" },
      ["6"] = { "<CMD>BufferLineGoToBuffer 6<CR>", " 5" },
      ["7"] = { "<CMD>BufferLineGoToBuffer 7<CR>", " 6" },
      ["8"] = { "<CMD>BufferLineGoToBuffer 8<CR>", " 7" },
      ["9"] = { "<CMD>BufferLineGoToBuffer 9<CR>", " 8" },
      ["0"] = { "<CMD>BufferLineGoToBuffer 10<CR>", " 9" },
    },
  },
