return {
  setup = function(colors)
    ...
    hi("LspReferenceText", { guifg = colors.syntax.color12, guibg = colors.common.base01 })
    hi("LspReferenceRead", { guifg = colors.syntax.color16, guibg = colors.common.base01 })
    hi("LspReferenceWrite", { guifg = colors.syntax.color06, guibg = colors.common.base01 })
