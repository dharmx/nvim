...
function B.get(theme)
  return {
    ["NotifyINFOBody"] = { background = theme.shades.shade07, foreground = theme.common.base09 },
    ["NotifyINFOBody2"] = { link = "NotifyINFOBody" },
    ["NotifyINFOBorder"] = { background = theme.shades.shade07, foreground = theme.shades.shade07 },
