...
function U.get(theme)
  return {
    ...
    NormalFloat = { foreground = theme.common.base04, background = theme.shades.shade07 },
    cheatSeparator = { foreground = theme.common.base02 },
    FloatBorder = { foreground = theme.common.base08 },
    ...
    Pmenu = { background = theme.shades.shade11, foreground = theme.common.base04 },
    PmenuSel = { background = theme.common.base09, foreground = theme.common.base01, decoration = "bold" },
    PmenuSbar = { background = theme.shades.shade03 },
    PmenuThumb = { background = theme.common.base14 },
